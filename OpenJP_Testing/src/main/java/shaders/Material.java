...
public class Material {
	...
	private MaterialUBO ubo = new MaterialUBO();
	...
	public void setTexture(Texture2D texture) {
		...
		if (texture != null) {
			ubo.setTexture(texture);
			ubo.setTextured(true);
			ubo.setTextureScale(textureScale);
			ubo.setTextureOffset(textureOffset);
		}
		ubo.setTextured(false);
	}
	/**
